...
# Exp-2: MDA Margin Loss
# Uses LLM-generated Minimum Distinguishing Attributes for margin loss.
# MDA text embeddings are pre-computed and cached; margin loss uses
# dot product between query embeddings and MDA embeddings.
model = dict(
    bbox_head=dict(
        mda_margin_config=dict(
...
# (same as Exp-1, ensures confusable classes appear in prompt for base loss)
train_pipeline = [
